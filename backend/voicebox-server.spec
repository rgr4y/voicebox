...
# MLX is macOS/Apple Silicon only — skip on other platforms
if sys.platform == 'darwin':
    hiddenimports += ['backend.backends.mlx_backend', 'mlx', 'mlx.core', 'mlx.nn', 'mlx_audio', 'mlx_audio.tts', 'mlx_audio.stt']
